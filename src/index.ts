...
import { connectPostgresPrisma, disposePostgresPrisma } from './main/postgresDb';
...
app.on('ready', () => {
  ...
  void connectPostgresPrisma().catch((error) => {
    console.warn(
      `[postgres-prisma] ${error instanceof Error ? error.message : String(error)}`,
    );
  });
